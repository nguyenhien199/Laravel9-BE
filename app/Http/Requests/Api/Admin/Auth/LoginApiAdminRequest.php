...
/**
 * @OA\Schema(
 *     schema="Requests.Api.Admin.Auth.Login",
 *     title="Requests.Api.Admin.Auth.Login",
 *     description="Request Login body data",
 *     type="object",
 *     required={"username", "password"},
 * )
 */
final class LoginApiAdminRequest extends BaseApiFormRequest
{
    /**
     * @OA\Property(property="username", type="string", format="string", minLength=5, nullable=false, example="",
     *      description="Username to login. <br/>for test env: `admin@example.com`.",
     * ),
