...
namespace App\Http\Requests\Api\Admin\Users\Profiles\Password;
...
/**
 * @OA\Schema(
 *     schema="Requests.Api.Admin.Users.Profiles.Password.Update",
 *     title="Requests.Api.Admin.Users.Profiles.Password.Update",
 *     description="User profile change password request body data",
 *     type="object",
 *     required={"current_password", "password", "password_confirmation"},
 * )
 */
class UserProfilePasswordUpdateApiAdminRequest extends BaseApiFormRequest
{
    /**
