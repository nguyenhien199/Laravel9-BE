...
/**
 * @OA\Schema(
 *      schema="Requests.Api.Admin.Users.Create",
 *      title="Requests.Api.Admin.Users.Create",
 *      description="Request create new User body data",
 *      type="object",
 *      required={"email", "password", "firstname", "lastname", "phone"},
 * )
 */
final class UserCreateApiAdminRequest extends BaseApiFormRequest
{
    /**
     ...
     *      description="Status in list: (`1`: active(display), `0`: inactive(not display)). <br/>If not, default: `1`."
     * ),
