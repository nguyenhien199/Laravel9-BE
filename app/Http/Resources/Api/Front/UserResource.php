...
/**
 * @OA\Schema(
 *      schema="Resources.Api.Front.User",
 *      title="Resources.Api.Front.User",
...
final class UserResource extends BaseResource
{
    ...
    {
        if ($field == 'birthday' && !empty($model->{$field})) {
     ...
     * ),
     * @OA\Property(property="username", type="string", nullable=false, example="user@example.com",
