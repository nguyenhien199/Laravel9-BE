...
return [
    ...
    */
    ...
    'back_to_system_url' => env('LOG_VIEWER_BACK_TO_URL', config('app.url')),

    'back_to_system_label' => env('LOG_VIEWER_BACK_TO_LABEL', null), // Displayed by default: "Back to {{ app.name }}"
    ...
    */
    ...
    'middleware' => array_merge(
        !empty(env('LOG_VIEWER_MIDDLEWARE')) ? explode(',', env('LOG_VIEWER_MIDDLEWARE')) : [],
        [
            'web',
    ...
    */
    ...
    'api_middleware' => array_merge(
        !empty(env('LOG_VIEWER_API_MIDDLEWARE')) ? explode(',', env('LOG_VIEWER_API_MIDDLEWARE')) : [],
        [
    ...
    */
    ...
    'hosts' => [
        'local' => [
            'name' => ucfirst(config('app.env', 'local')),
        ],
