...
return [
     ...
     */
    'date_format' => env('DATA_DATE_FORMAT', DATE_ATOM),
    ...
    /**
     * Paginator info can be wrapped into a key like 'meta' when used as a resource,
     * this key can be set globally here for all Paginator.
     */
    'paginator_meta' => env('DATA_PAGINATOR_META', 'pagination'),

    /**
     * Pagination data list can be wrapped into a key like 'data' when used as a resource.
     * If you pass `null`, it will default to data.wrap .
     */
    'paginator_wrap' => env('DATA_PAGINATOR_WRAP', 'items'),

    /**
     * Is it allowed to display Links list in pagination?
     */
    'paginator_links_enabled' => env('DATA_PAGINATOR_LINK_ENABLED', false),
